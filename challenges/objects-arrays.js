...
const unisWithUni = graduates.filter(graduate => graduate.university.toLowerCase().includes("uni"));
...
const populationTotal = zooAnimals.reduce((acc, name) => acc + name.population, 0);
